    ...
    <div className="main-container">
      ...
      <div className="other-container">
        ...
        <div className="row">
          ...
          <div className="col s12 m5 l6 colFlex">
            <div className="secondary workday" onClick={(event) => { handleClick('https://gregoryjohncarter.github.io/workday-scheduler/', event); }} style={{cursor:"pointer"}}>
              <SocialIcon url='https://github.com/gregoryjohncarter/workday-scheduler' className="iconHover" bgColor="#e0d4ec" fgColor="#2d2d2d" style={{ height: 45, width: 45}} target="_blank"/><p className="fontTwoA">Work Day Scheduler<span className="fontOneA">&rarr; JS, localStorage</span></p>
            </div>
          </div>
        </div>
      </div>
