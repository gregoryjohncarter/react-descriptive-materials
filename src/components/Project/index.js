        ...
        <div className="row">
          ...
          <div className="col s12 l6 colFlex">
            <div className="secondary thought" onClick={(event) => { handleClick('https://news-to-attend-to.herokuapp.com/', event); }} style={{cursor:"pointer"}}>
              <SocialIcon url='https://github.com/gregoryjohncarter/news-to-attend-to' className="iconHover" bgColor="#2d2d2d" fgColor="#e8e8e8" style={{ height: 45, width: 45}} target="_blank"/><p className="fontTwoA grating" onClick={(event) => { handleClick('https://news-to-attend-to.herokuapp.com/', event); }}>News to Attend to<span className="fontOneA" onClick={(event) => { handleClick('https://news-to-attend-to.herokuapp.com/', event); }}>&rarr; React, News API</span></p>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col s12 l6 colFlex">
              <div className="secondary wo" onClick={(event) => { handleClick('https://workout-assistant-mern.herokuapp.com/', event); }} style={{cursor:"pointer"}}>
                <SocialIcon url='https://github.com/gregoryjohncarter/Workout-Assistant' className="iconHover" bgColor="#2d2d2d" fgColor="#e8e8e8" style={{ height: 45, width: 45}} target="_blank"/><p className="fontTwoA grating" onClick={(event) => { handleClick('https://workout-assistant-mern.herokuapp.com/', event); }}>Workout Assistant<span className="fontOneA" onClick={(event) => { handleClick('https://workout-assistant-mern.herokuapp.com/', event); }}>&rarr; MERN, Apollo</span></p>
              </div>
            </div>
            <div className="col s12 l6 colFlex">
          ...
          <div className="row">
            ...
            <div className="col s12 l6 colFlex">
              <div className="secondary screen-title" onClick={(event) => { handleClick('https://yks2728.github.io/Screen-Title-Scanner/', event); }} style={{cursor:"pointer"}}> 
                <SocialIcon url='https://github.com/yks2728/Screen-Title-Scanner' className="iconHover" bgColor="#2d2d2d" fgColor="#e8e8e8" style={{ height: 45, width: 45}} target="_blank"/><p className="fontTwoA" onClick={(event) => { handleClick('https://yks2728.github.io/Screen-Title-Scanner/', event); }}>Screen Title Scanner <span className="fontOneA" onClick={(event) => { handleClick('https://yks2728.github.io/Screen-Title-Scanner/', event); }}>&rarr; jQuery, imdb API</span></p>
              </div>
            </div>
          </div>
        </div>
