...
function App() {
  ...
  const [categories] = useState([
    {
      section: 'About Me',
      description: 'Web developer with a thoughtful and positive perspective. Possesses a strong foundation in JavaScript and React. Gained experience during completion of a full stack boot camp. Proficiencies include HTML5, CSS3, Node.js, React.js, Python, Java, Spring Boot, and RESTful API.',
      icon: 'account_circle' 
    },
